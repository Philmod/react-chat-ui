    ...
    ChatBubble.prototype.render = function () {
        ...
        return (React.createElement("div", { style: __assign({}, styles_1.default.chatbubbleWrapper) },
            React.createElement("div", { style: chatBubbleStyles },
                React.createElement("p", { style: __assign(__assign({}, styles_1.default.p), text) }, m.text),
                m.imageUrls && m.imageUrls.map(function (url) { return (React.createElement("img", { style: styles_1.default.img, src: url })); }))));
    };
    return ChatBubble;
}(React.Component));
